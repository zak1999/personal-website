...
export default function Toggle() {
  ...
  return (
    <div className='t' style={{
      ...
      <svg className="t-icon" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"  viewBox="0 0 16 16">
      ...
      <div className="t-button" onClick={handleClick} style={{left: darkMode ? 0: 29}}></div>
    </div>
  )
}
// 